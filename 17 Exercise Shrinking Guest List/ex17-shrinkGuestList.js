...
var guestList = ["Sir Daniyal Naghori", "Sir Ameen Alam", "Sir Zia Khan"];
...
guestList.forEach(function (oneguest) { return console.log(" Asalam-O-Aleikum\n\nMr. ".concat(oneguest, "\n\nWould you like to Dinner with me.\n\nThankyou!\n\n ")); });
console.log("Unfortunatly, Sorry to say we can't arrange big table so we invite only two guests.\n\n");
while (guestList.length > 2) {
    var removeguest = guestList.pop();
    console.log("Sorry ".concat(removeguest, ", you can't participate our dinner.\" due to can't arrived big table.\n\n "));
}
